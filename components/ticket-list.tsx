          ...
          <DialogContent className="max-w-3xl">
            <DialogHeader>
              ...
              <DialogDescription className="flex items-center gap-1">
                <MapPin className="h-3 w-3" /> {selectedTicket.location} •{" "}
                    ...
                    <div className="flex items-start gap-2">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-green-600">
                          No safety violations detected. All safety protocols
            ...
            selectedTicket.recommendations.length > 0 ? (
              <div>
              ...
              selectedTicket.status === "compliant" && (
                <div className="rounded-md border border-green-100 bg-green-50 p-4">
                  <div className="flex items-start gap-2">
                    <CheckCircle className="mt-0.5 h-5 w-5 shrink-0 text-green-500" />
                    <div>
                      ...
                      <p className="text-sm text-green-600">
                        Continue maintaining current safety standards. No
