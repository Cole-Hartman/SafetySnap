    ...
    violations: [
      {
        title: "Exposed Electrical Wiring",
        description:
          "Electrical wires are exposed and accessible to workers, creating a shock hazard.",
        severity: "high",
      ...
      },
      {
        ...
        description:
          "Electrical conduit is damaged and not properly secured to the wall.",
        severity: "medium",
    ...
    violations: [
      {
        title: "Missing Machine Guards",
        description:
          "Machine is operating without required safety guards, exposing moving parts.",
        severity: "high",
    ...
    violations: [
      {
        ...
        description:
          "Employee using ladder with visible structural damage (cracked rung).",
        severity: "medium",
    ...
    violations: [
      {
        ...
        description:
          "Fire exit pathway is partially blocked, reducing evacuation efficiency.",
        severity: "medium",
